   ...
   <MainLayout>
        <div class="flex flex-col p-5">
            ...
            <div class="flex items-center mt-4">
                ...
                <input v-model="search" class="outline-none border-2 focus:border-red-400 border-l-0 border-red-600 rounded-tr rounded-br w-1/2 h-8 text-center" type="text" id="search">
            </div>
            <br>
                        ...
                        <div class="flex flex-row gap-2">
                                <template v-if="!item.is_deleted">
                                    ...
                                    <div @click="onDelete(item)">
                                        <button class="hover:bg-red-500 transition-all duration-300 text-white font-light text-[font-size:8px] w-14 rounded  bg-red-600">
                                            Delete
                                        </button>
                                    </div>
                            ...
                            <div v-else>
                                <button class="bg-indigo-700 w-20 rounded text-white"
