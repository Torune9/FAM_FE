    ...
    <nav class="fixed right-0 bg-blueHunt top-0 w-4/5 flex justify-end h-16 items-center">
      <div class="flex flex-wrap justify-center items-center gap-4 w-[30%]">
        ...
        <div class="w-14 h-14 overflow-hidden flex justify-center items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 6.615 6.615" id="profile">
            <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".265"
            ...
            <path fill="#81bcf3"
              ...
              color="#000" font-family="sans-serif" font-weight="400" overflow="visible" paint-order="markers stroke fill"
            ...
            <path fill="#6ea9e3"
              ...
              color="#000" font-family="sans-serif" font-weight="400" overflow="visible" paint-order="markers stroke fill"
              transform="translate(-26.458) scale(.26458)"></path>
            <path fill="#d9d7e4"
              style="line-height:normal;font-variant-ligatures:normal;font-variant-position:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-alternates:normal;font-feature-settings:normal;text-indent:0;text-align:start;text-decoration-line:none;text-decoration-style:solid;text-decoration-color:#000;text-transform:none;text-orientation:mixed;shape-padding:0;isolation:auto;mix-blend-mode:normal"
