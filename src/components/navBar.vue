<template>
    <nav class=" bg-slate-700 text-zinc-100 w-[20%] p-4 h-screen">
    ...
    <nav class="absolute right-0 bg-slate-600 top-0 w-4/5 flex justify-end h-14 items-center">
       <div class="flex flex-wrap justify-center items-center gap-4 w-[30%]">
        <h1 class=" text-zinc-200 font-semibold">Akhsan</h1>
        <div class=" ">
